            ...
            {leads.map((lead, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="py-3 px-2">
                    <span className="inline-flex items-center rounded-full px-2 py-0.5 text-xs bg-violet-50 text-violet-700 dark:bg-violet-950/40 dark:text-violet-300 ring-1 ring-inset ring-violet-200 dark:ring-violet-800">
                      {lead.service_type || '—'}
                    </span>
                  </td>
          ...
          >
            <div className="flex items-start gap-3">
              ...
              >
                <Star
                  className={`w-4 h-4 ${
                    isFavorite ? 'fill-amber-400 text-amber-400' : 'text-slate-300 dark:text-slate-600'
                  }`}
                />
              </button>
            </div>
