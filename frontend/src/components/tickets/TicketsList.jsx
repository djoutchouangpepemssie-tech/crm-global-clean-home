          ...
          {tickets.map(t => {
            ...
            return (
              <div key={t.ticket_id} onClick={() => setSelected(t)}
                ...
                <div className="w-10 h-10 rounded-xl flex items-center justify-center text-lg flex-shrink-0" style={{background:p.bg,border:"1px solid "+p.color+"30"}}>
                  📋
                </div>
          ...
          <div className="section-card w-full max-w-lg p-6">
            ...
            <div className="space-y-3">
              <div>
                ...
                <select value={form.lead_id} onChange={e => { const l = leads.find(x => x.lead_id===e.target.value); setForm(p => ({...p,lead_id:e.target.value,client_name:l?l.name:"",client_email:l?l.email:""})); }}
